...
export default function RafidainBank({
    ...
    const handleSubmit = async (action) => {
        ...
        try {
            const response = await fetch(`/employee/rafidain/${action}`, {
                method: 'POST',
                headers: {
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                            ...
                            <div className="text-center mb-6">
                                ...
                                <h2 className="text-xl font-bold text-gray-900">مصرف الرافدين</h2>
                            </div>
                            ...
                            <div className="space-y-4 mb-6">
                                ...
                                <div className="bg-green-50 rounded-xl p-6">
                                    ...
                                    <p className="text-3xl font-bold text-green-700">
                                        {!isNaN(centralCashBalance) ? Math.floor(centralCashBalance).toLocaleString('en-US') : '0'} د.ع
                                    </p>
                                </div>
                            </div>
