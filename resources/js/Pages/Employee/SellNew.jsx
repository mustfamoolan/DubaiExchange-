...
export default function Sell() {
    const [formData, setFormData] = useState({
        documentNumber: 'SELL20250810001',
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <input
                                type="text"
                                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent text-right bg-gray-50"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div className="bg-orange-50 rounded-xl p-4">
                            <div className="flex justify-between items-center">
                                <span className="text-lg font-semibold text-orange-800">المبلغ الكلي (دولار):</span>
                                <span className="text-2xl font-bold text-orange-700">${getTotalDollar().toLocaleString()}</span>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <button
                            onClick={handleSave}
                            className="bg-orange-500 hover:bg-orange-600 text-white font-semibold py-3 px-6 rounded-xl transition-colors duration-200 flex items-center justify-center"
                        >
