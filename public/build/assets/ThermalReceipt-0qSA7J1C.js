...
المجموع: ${e.total_amount} د.ع
التاريخ: ${e.created_at}
الموظف: ${e.employee_name}`;await navigator.share({title:`فاتورة ${e.service_name} - ${e.receipt_number}`,text:n})}}catch(n){console.error("خطأ في المشاركة:",n)}finally{f(!1)}},t=()=>`
        <!DOCTYPE html>
